...
function Services() {
  return (
    <section
      id="servicios"
      className="relative min-h-[auto] md:min-h-screen max-w-6xl mx-auto flex flex-col items-center justify-center mt-0 md:mt-10 px-4"
    >
      {/* Título y descripción */}
      <div className="text-center mb-7">
        <h1 className="font-bold text-3xl sm:text-5xl lg:text-6xl mb-6 text-gray-900 leading-tight">
